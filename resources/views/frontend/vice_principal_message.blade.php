...
<ul class="dropdown-menu"  role="menu">
	...
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-3352" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3352 nav-item"><a href="#" class="dropdown-item"><span class="menu-text">Ex Teachers</span></a></li>
</ul>
</li>
			...
			<div class="container main-area-bg">
				<div class="row">
					<div class="col-md-9">
						<article>
							<div class="entry">
								<h1 class="heading">উপাধ্যক্ষের পরিচয়</h1>
								<div class="clearfix">
									<div class="row">
										<div class="col-sm-4">
											<div class="clearfix">
								...
								<br/>
								<div></div>
								<h1 class="heading mt-3">উপাধ্যক্ষের বাণী</h1>
								<div>
									{!! $setting->vice_principal_message !!}
									<p><strong>{{ $setting->vice_principal_name }}, উপাধ্যক্ষ</strong></p>
								</div>
							</div>
						</article>
					</div>					
