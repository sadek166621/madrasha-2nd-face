            ...
            <div class="col-md-9">
                <article>
                    <div class="entry">
                        ...
                        <h1 class="heading mt-3">Curriculum</h1>
                        <br>
                        <div>
                            <table class="newspaper-n">
                                <tbody>
                                    ...
                                    @if(count($curriculum) > 0)
                                        @foreach ($curriculum as $key => $notice)
                                            <tr>
                                                <td align="center">{{ $key+1 }}</td>
                                                <td align="left">{{ $notice->title }}</td>
                                                <td align="center" class="text-center">
                                                    @if($notice->link)
                                                        <a href="{{ asset('assets/files/uploads/curriculum') }}/{{ $notice->link }}" target="_blank"><i class="fa fa-download"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
                            ...
                            {{-- {!! $campusmale->Quranic_Arabic_Course !!} --}}
                        </div>
                    </div>
                </article>
            </div>
